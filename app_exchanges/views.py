...
def admin_dashboard(request):
    ...
    if request.method == "POST":
        if 'exchange' in request.POST:
            ...
            if exchange_form.is_valid():
                exchange_form.save()
                messages.success(request, "Exchange successfully created!")  # Add this line
            ...
            if commodity_form.is_valid():
                commodity_form.save()
                messages.success(request, "Commodity successfully created!")  # Add this line
                return redirect('admin_dashboard')
            else:
            ...
            if currency_form.is_valid():
                currency_form.save()
                messages.success(request, "Currency successfully created!")  # Add this line
                return redirect('admin_dashboard')
            else:
            ...
            if exchanges_commodities_form.is_valid():
                ...
                messages.success(request, "Exchanges commodities successfully created!")  # Add this line
                return redirect('admin_dashboard')
            else:
    ...
    return render(request, 'admin_dashboard.html', {
        ...
        'messages': messages.get_messages(request),  # Add this line
    })
